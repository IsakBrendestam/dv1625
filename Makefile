...
$(PROGRAM_FILE): $(BUILD)/Main.o $(BUILD)/Application.o $(BUILD)/Debug.o $(BUILD)/Grid.o $(BUILD)/Cell.o
	$(GCC) $(INC) $(LIB) $(VS) -o $(PROGRAM_FILE) $(BUILD)/Main.o $(BUILD)/Application.o $(BUILD)/Debug.o $(BUILD)/Grid.o $(BUILD)/Cell.o $(DEP)
